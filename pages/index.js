            ...
            <div className="pt-12 text-center">
              <div className="max-w-2xl mx-auto mb-8">
                ...
                <div className="text-blueGray-400 leading-relaxed wow animate__animated animate__fadeIn d-inline">
                  We are <strong className="text-blue-500">Enresoft</strong>, a
                  Custom{" "}
                  <div className="typewrite d-inline text-brand">
                    <TextEffect
                      text1="Tailored solutions."
                      text2="Software Development company."
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="container px-4 mx-auto">
            <div className="flex flex-wrap lg:flex-nowrap">
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-blueGray-400 leading-loose">
                        Creative design services that enhance user experience
                        and interface.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-blueGray-400 leading-loose">
                        Professional software development with a focus on
              ...
              <div className="relative w-full lg:w-1/2 my-12 lg:my-0">
                ...
                >
                  <img
                    className="jump relative mx-auto rounded-xl w-2/3 z-10"
                    src="/assets/imgs/customs/key-features.jpg"
                    alt="Enresoft"
                  />
                  <img
            ...
            <div className="flex flex-wrap items-center justify-between max-w-2xl lg:max-w-full mb-12">
              ...
              <div className="w-full lg:w-1/2">
                <p className="text-blueGray-400 leading-loose wow animate__animated animate__fadeIn">
                  We are a talented and dedicated team committed to turning your
                  business dreams into reality. With our expertise in creative
                  design and custom software development, we partner with you to
                  bring your vision to life and drive your success.
                </p>
              </div>
            </div>
            <div className="flex flex-wrap -mx-3 -mb-6 text-center">
              ...
              >
                <div className="p-12 bg-white shadow rounded">
                  ...
                  <img
                    className="h-45 mx-auto my-4 rounded-lg"
                    src="https://plus.unsplash.com/premium_photo-1726704033144-224d8de7edf9?q=80&w=2970&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt="Monst"
                  />
              ...
              >
                <div className="p-12 bg-white shadow rounded">
                  ...
                  <img
                    className="h-45 mx-auto my-4 rounded-lg"
                    src="https://plus.unsplash.com/premium_photo-1726704163434-fd7dca570bd3?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjJ8fHBsYW5uaW5nfGVufDB8MHwyfHx8MQ%3D%3D"
                    alt="Monst"
                  />
                  <h3 className="mb-2 font-bold font-heading text-xl">
                    Project planning
              ...
              <div className="hover-up-5 w-full lg:w-1/3 px-3 mb-6">
                ...
                >
                  ...
                  <img
                    className="h-45 mx-auto my-4 rounded-lg"
                    src="https://plus.unsplash.com/premium_photo-1726736739591-0d78cc09844d?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8b3JnYW5pemF0aW9ufGVufDB8MHwyfHx8MQ%3D%3D"
                    alt="Monst"
                  />
                  <h3 className="mb-2 font-bold font-heading text-xl">
          ...
          <div className="container text-center">
            ...
            <div className="flex flex-wrap -mx-3">
              ...
              >
                ...
                />
                <p className="mt-6">
                  <strong className="text-md">Sedat Dilmac</strong>
                </p>
              ...
              >
                ...
                />
                <p className="mt-6">
                  <strong className="text-md">Ismail Guldu</strong>
                </p>
              ...
              >
                ...
                />
                <p className="mt-6">
                  <strong className="text-md">Tolga Dincel</strong>
                </p>
                <p className="text-gray-500 text-xs mb-4">Business Analyst</p>
                <div className="flex py-1 justify-center space-x-2">
                  <img src="/assets/imgs/icons/facebook.svg" alt="Monst" />
              ...
              >
                ...
                />
                <p className="mt-6">
                  <strong className="text-md">Reha Salmaner</strong>
                </p>
              ...
              >
                ...
                />
                <p className="mt-6">
                  <strong className="text-md">Abdullah Koclar</strong>
                </p>
            ...
            <div className="flex flex-wrap mb-24">
              ...
              <div className="w-full lg:w-1/2 lg:pl-24 my-auto">
                ...
                <h2
                  ...
                  data-wow-delay=".3s"
                >
                  Enresoft transformed our business with their tailored software
                  solutions and creative design. Their expertise and
                  professionalism were exceptional. Highly recommended!
                </h2>
